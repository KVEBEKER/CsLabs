using ServerConfigProgram;

namespace ServerConfigProgram.Tests
{
    public class Tests
    {
        [Test]
        ...
        public void CheckConfiguration_TooManyPlayersForAvailableMemory_LaunchWithWarning()
        {
            ...
            Assert.That(
                result,
                Is.EqualTo("Запуск возможен с предупреждением: для такого количества игроков рекомендуется больше оперативной памяти."));
        }
